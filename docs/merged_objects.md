...
| `library_id`                   | Library ID in the form `SCPCL000000`                                                                                                                                                                                                                                                                                                                                               || `salmon_version`               | Version of `salmon` used for initial mapping
| `project_id`                   | Project ID in the form `SCPCP000000`                                                                                                                                                                                                                                                                                                                                               || `salmon_version`               | Version of `salmon` used for initial mapping
