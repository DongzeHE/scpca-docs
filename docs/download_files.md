...
![project download folder](images/project-download-folder.png){width="500"}

### Download folder structure for individual sample downloads:
![sample download folder](images/sample-download-folder.png){width="500"}

## `AnnData` downloads

### Download folder structure for project downloads:
![project download folder](images/anndata-project-download-folder.png){width="500"}

### Download folder structure for individual sample downloads:
![sample download folder](images/anndata-sample-download-folder.png){width="500"}

### Download folder structure for individual sample downloads with CITE-seq (ADT) data:
![sample download folder](images/anndata-sample-citeseq-download-folder.png){width="500"}
...
![multiplexed project download folder](images/multiplexed-download-folder.png){width="500"}
...
![project download folder](images/merged-project-download-folder.png){width="500"}

### Download folder structure for `AnnData` merged downloads:
![project download folder](images/merged-anndata-project-download-folder.png){width="500"}

### Download folder structure for `AnnData` merged downloads with CITE-seq (ADT) data:
![project download folder](images/merged-anndata-project-citeseq-download-folder.png){width="500"}
...
![sample download with spatial](images/spatial-download-folder.png){width="500"}
